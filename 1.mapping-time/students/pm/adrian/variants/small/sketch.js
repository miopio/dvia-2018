...
//are non-stationary and change as the get closer to the full DD HH and MM respectively
    // var hhColor = color(120+hh*5,0,0,100); //Turned off for the small project
    // var mmColor = color(0+mm*2,240-mm*4,0,100); //Turned off for the small project
    // var ssColor = color(0,120+ss*2,240-ss*4,100); //Turned off for the small project
