...
//are non-stationary and change as the get closer to the full DD HH and MM respectively
    var hhColor = color(120+hh*5,0,0,20);
    var mmColor = color(0+mm*2,240-mm*4,0,20);
    var ssColor = color(0,120+ss*2,240-ss*4,20);

    // var hhColor = color(120+hh*5,0,0,20);
    // var mmColor = color(0+mm*2,240-mm*4,0,20);
    // var ssColor = color(0,120+ss*2,240-ss*4,20);

    // var hhColor = color(255,0,0,100);
    // var mmColor = color(0,255,0,100);
    // var ssColor = color(0,0,250,100);
...
//Creates the borders for the MO and DD coordinates, this is a X, Y vs. X=Y system used below
    ...
    ellipse(50,50,25,25);
    ellipse(832,50,25,25);
    ellipse(50,832,25,25);
    ellipse(832,832,25,25);
