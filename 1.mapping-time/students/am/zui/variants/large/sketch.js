...
function draw() {
  ...
  // bg colors
  if (now.season == 1 ) background(254,223,225); // pink if spring
  if (now.season == 2 ) background(129,199,212); // ltblue if summer
  if (now.season == 3 ) background(247,194,66); // yellow if fall
  if (now.season == 4 ) background(255,255,251); // white if winter
