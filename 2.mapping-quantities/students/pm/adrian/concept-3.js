...
// noStroke ();
// fill (200,25); ellipse (452,62,24,24);
// fill (200,25); ellipse (482,62,24,24);
// fill (200,25); ellipse (558,62,24,24);
// fill (200,25); ellipse (588,62,24,24);
// fill (200,25); ellipse (646,62,24,24);
// fill (200,25); ellipse (682,62,24,24);
// fill (200,25); ellipse (694,62,24,24);
// fill (200,25); ellipse (714,62,24,24);
// fill (200,25); ellipse (716,62,24,24);
// fill (200,25); ellipse (768,62,24,24);
// fill (200,25); ellipse (880,62,24,24);
// fill (200,25); ellipse (944,62,24,24);
// fill (200,25); ellipse (1010,62,24,24);
// fill (200,25); ellipse (1128,62,24,24);
// fill (200,25); ellipse (1262,62,24,24);
// fill (200,25); ellipse (1268,62,24,24);
// fill (200,25); ellipse (1284,62,24,24);
// fill (200,25); ellipse (1294,62,24,24);
// fill (200,25); ellipse (1308,62,24,24);
// fill (200,25); ellipse (1310,62,24,24);
// fill (200,25); ellipse (1358,62,24,24);
// fill (200,25); ellipse (1360,62,24,24);
// fill (200,25); ellipse (1392,62,24,24);
// fill (200,25); ellipse (1408,62,24,24);
// fill (200,25); ellipse (1480,62,24,24);
// fill (200,25); ellipse (1544,62,24,24);
// fill (200,25); ellipse (1554,62,24,24);
// fill (200,25); ellipse (1566,62,24,24);
// fill (200,25); ellipse (1600,62,24,24);
// fill (200,25); ellipse (1608,62,24,24);
// fill (200,25); ellipse (1608,62,24,24);
// fill (200,25); ellipse (1680,62,24,24);
// fill (200,25); ellipse (1720,62,24,24);
// fill (200,25); ellipse (1738,62,24,24);
// fill (200,25); ellipse (1746,62,24,24);
// fill (200,25); ellipse (1780,62,24,24);
// fill (200,25); ellipse (1782,62,24,24);
// fill (200,25); ellipse (1782,62,24,24);
// fill (200,25); ellipse (1806,62,24,24);
// fill (200,25); ellipse (1830,62,24,24);
// fill (200,25); ellipse (1830,62,24,24);
// fill (200,25); ellipse (1830,62,24,24);
// fill (200,25); ellipse (1854,62,24,24);
// fill (200,25); ellipse (1878,62,24,24);

//To add a point to mark the month and year of the treaty, not that this can be used in combination of the ellipse above
stroke(0);
strokeWeight(3);
point (452,62);
point (482,62);
