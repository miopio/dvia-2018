...
// var urimp = [6.6, 17.1, 8.2, 12.5, 11.7, 13.5, 15.1, 15.8, 13.1,  23.7, 16.3, 23.3];
    ...
    strokeWeight(2);
    stroke('hotpink');
    line(xxx+100,(windowHeight-120),xxx+120,(windowHeight-120));
    stroke('cornflowerblue');
    line(xxx+235,(windowHeight-120),xxx+255,(windowHeight-120));
    stroke('lightseagreen');
    line(xxx+345,(windowHeight-120),xxx+365,(windowHeight-120));
    stroke('mediumslateblue');
    line(xxx+455,(windowHeight-120),xxx+475,(windowHeight-120));
    stroke('dimgray');
    line(xxx+540,(windowHeight-120),xxx+560,(windowHeight-120));
    stroke('goldenrod');
    line(xxx+650,(windowHeight-120),xxx+670,(windowHeight-120));
    stroke('olivedrab');
    line(xxx+740,(windowHeight-120),xxx+760,(windowHeight-120));
    stroke('salmon');
    line(xxx+880,(windowHeight-120),xxx+900,(windowHeight-120));
