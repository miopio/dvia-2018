  ...
  for (var war in wardata){
    for (var i=0; i<wardata[war].length; i++){
      ...
      if (N<8){
        ...
        if ((mouseX>=startX && mouseX<=endX) && mouseY==coordY){
          mouseOver = true;
        } else {
          mouseOver = false;
        }
        ...
        if (mouseOver==true){
          textSize(8);
          text("Start of "+wardata[war],startX, coordY-10);
          text("End of "+wardata[war],endX, coordY-10);
          ...
          fill('#62592C');
          // start of the war
          ellipse(startX, coordY, 5, 5);
          // end of the war
          ellipse(endX, coordY, 5, 5);
          // length of the war
          strokeWeight(1.5);
          stroke('#62592C');
          line(250+(start-1945)*colWidth, 500-rowHeight*N, 250+(end-1945)*colWidth, 500-rowHeight*N);
