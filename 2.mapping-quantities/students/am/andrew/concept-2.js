...
function preload() {
  ...
  decades = loadJSON("data/decade_basic.json");
}
...
function setup() {
  ...
  text("USA", 50, 50);
  text(data.tests["United States"][0], 90, 50);
  ...
  rect(
    50 +
      data.tests["United States"][0] * 2 +
      data.tests["United States"][1] * 2,
    50,
    data.tests["United States"][2] * 2,
    30
  );
  ...
  fill("red");
  rect(
    50 + data.tests["United States"][0] * 2,
    50,
    data.tests["United States"][1] * 2,
    30
  );
  ...
  fill("white");
  stroke("black");
  rect(50, 50, data.tests["United States"][0] * 2, 30);
